...
class My_booking extends CI_Controller {
	...
	{	
		...
		$config = array();
		$config['base_url'] = base_url().'car/my_booking/index/';
		...
		$latest_booking = $this->general->get_list_view('car_booking', 'user_id', $data['account']->id, $book_select = NULL, 'booking_id', 'desc', $page, $config["per_page"]);

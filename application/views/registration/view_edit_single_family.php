            ...
            <table class="table table-bordered table-striped">            	
                <tr>
                    ...
                    <select name="reg_site" class="input-large" id="reg_site">
                        ...
                        <option value="<?php echo $site1->site_id; ?>" <?php if($family_info->site_id==$site1->site_id) echo "selected"; ?> ><?php echo $this->session->userdata('site_lang')=='english'? $site1->site_name:$site1->site_name_bn; ?></option>
                        <?php endforeach; ?>
                    </select>
                    ...
                    <option value=""><?php echo lang('settings_select'); ?></option>   
                    <?php if($family_info->sp_id){ ?><option value="<?=$family_info->sp_id?>" selected><?php echo $this->ref_site_model->get_site_name_by_id($family_info->sp_id); ?></option>  <?php }?>           
                    </select>        
                    </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <div class="span8">
                    <input id="household_name" name="household_name" type="text" value="<?=$family_info->household_name?>" placeholder="<?=lang('household_name')?>" class="form-control"/>  
                    </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <div class="span8">
                    <input id="apartment_name" name="apartment_name" type="text" value="<?=$family_info->apartment_name?>" placeholder="<?=lang('apartment_name')?>" class="form-control"/>  
                    </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <div class="span8">
                    <input id="apartment_number" name="apartment_number" type="text" value="<?=$family_info->apartment_number?>" placeholder="<?=lang('apartment_number')?>" class="form-control"/>  
                    </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <div class="span8">
                    <input id="primary_contact_person" name="primary_contact_person" type="text" value="<?=$family_info->primary_contact_person?>" placeholder="User id" class="form-control"/>
                    </div>
                    </td>
                </tr>                    
            	...
            	<tr>   
            		...
            		<td>
                    <div class="span8">
                    <textarea class="form-control" id="family_note" name="family_note" placeholder="<?=lang('note')?>" rows="5"><?=$family_info->note?></textarea>
                    </div>
                    </td>
                </tr>                             
                ...
                <tr class="warning">   
                    ...
                    <div class="span8">
                        ...
                        <?php foreach ($services as $services1) : ?>
                            <option value="<?php echo $services1->services_id; ?>" <?php if($family_package_info->services_id==$services1->services_id) echo "selected"; ?>><?php echo $this->session->userdata('site_lang')=='english'? $services1->services_name:$services1->services_name_bn; ?></option>
                            <?php endforeach; ?>         
                        </select>        
                        ...
                        <option value=""><?php echo lang('settings_select'); ?></option> 
                         <option value="<?=$family_package_info->package_id?>" selected><?php echo $this->ref_services_model->get_package_name_by_id($family_package_info->package_id); ?></option>           
                        </select>                                                       

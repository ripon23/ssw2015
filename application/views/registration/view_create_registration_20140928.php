...
<?php echo $this->load->view('header'); ?>
	...
	<div class="control-group">
		...
		<span class="add-on" id="registration_no_part1"><?php if(isset($reg_no_part1)) echo $reg_no_part1;?></span>
        <span class="add-on" id="registration_no_part1_1"><?php if(isset($reg_no_part1_1)) echo $reg_no_part1_1;?></span>
        <span class="add-on" id="registration_no_part1_2"><?php if(isset($reg_no_part1_2)) echo $reg_no_part1_2;?></span>
        <span class="add-on" id="registration_no_part1gender"><?php if(isset($reg_no_part2)) echo $reg_no_part2; ?></span>
		<input class="input-small" style="text-align:center;" placeholder="Serial no" name="registration_no_part2" id="registration_no_part2" value="<?php if(isset($reg_no_part3)) echo $reg_no_part3; else  echo set_value('registration_no_part2');?>" type="text" />
		</div>

        ...
        <?php echo form_open(uri_string(),'class="form-horizontal"') ?>
                ...
                <table class="table table-bordered">                    
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="route_id" id="route_id">
                                ...
                                <option <?php echo ($route->route_id==$schedule_info->route_id)?"selected":"" ?> value="<?php echo $route->route_id?>"><?php echo $route->route_name_en?></option>
                                 <?php
                                }
                                ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>                        
                            <select id="start_node" name="start_node" class="input-large node_list">
                              ...
                              <?php foreach ($all_node as $node) {?>
                                <option <?php echo ($node->node_id==$schedule_info->start_node)?"selected":"" ?> value="<?php echo $node->node_id?>"><?php echo $node->node_name_en?></option>
                                 <?php
                                }
                                ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>                        
                            <select id="drop_node" name="drop_node" class="input-large node_list">
                                ...
                                <?php foreach ($all_node as $node) {?>
                                <option <?php echo ($node->node_id==$schedule_info->destination_node)?"selected":"" ?> value="<?php echo $node->node_id?>"><?php echo $node->node_name_en?></option>
                                 <?php
                                }
                                ?>
                        	</select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="car_id" id="car_id">
                                ...
                                <option <?php echo ($car->car_id==$schedule_info->car_id)?"selected":"" ?> value="<?php echo $car->car_id?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="<?php echo $schedule_info->schedule_date; ?>" class="input-medium" id="date1" name="sdate" placeholder="Start Date"> 
                            <span class="help-inline" style="color:#EF030A">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-append">
                                <input id="stime"  type="time" value="<?php echo substr($schedule_info->start_time,0,5); ?>" style="width:100px" class="input-mini timemask timepicker" name="stime" placeholder="hh:mm" value=""> <span class="add-on clearpicker"><i class="icon-time"></i></span>
                            </div> To 
                            <div class="input-append">
                                <input id="etime"  type="time" style="width:100px" value="<?php echo substr($schedule_info->arrival_time,0,5); ?>" class="input-mini timemask timepicker" name="etime" placeholder="hh:mm" value=""> <span class="add-on clearpicker"><i class="icon-time"></i></span>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="text" value="<?php echo $schedule_info->per_seat_fare; ?>" class="input-mini" id="per_seat_fare" name="per_seat_fare" placeholder="Fare"> TK
                        </td>  
                    </tr>
                    ...
                    <tr>
                        ...
                        <select name="status" id="status" class="selectpicker span2" data-style="btn">
                            ...
                            <option value="1" <?php echo $schedule_info->schedule_status == 1 ? 'selected' : '' ?> data-content="<span class='label label-success'><?php echo lang('active')?></span>" 
                            ><?php echo lang('active')?></option>
                            <option value="2" <?php echo $schedule_info->schedule_status == 2 ? 'selected' : '' ?> data-content="<span class='label label-warning'><?php echo lang('inactive')?></span>" ><?php echo lang('inactive')?></option>
                        </select>
                        <span class="help-inline" style="color:#EF030A">
                    ...
                    <tr>
                        <td align="right"></td>
                        <td><button type="submit" class="btn btn-primary" name="submit"><i class="icon-check icon-white"></i> <?php echo lang('website_update') ?></button></td>
                    </tr>
                </table>

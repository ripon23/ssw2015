        ...
        <tr class="success">
            ...
            <td><?=lang('phone')?>: <?=$registration_info->phone?></td>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                  	<input class="input-small"  name="total_travel_distance" id="total_travel_distance"  value="<?php echo set_value('total_travel_distance');?>" type="text" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input class="input-small"  name="total_travel_time" id="total_travel_time"  value="<?php echo set_value('total_travel_time');?>" type="text" /> 
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input class="input-small"  name="total_bill" id="total_bill"  value="<?php echo set_value('total_bill');?>" type="text" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <textarea rows="5" name="note" id="note" class="input-xlarge"><?php echo set_value('note');?></textarea>  
                    </div>
                </div>

...
<?php echo $this->load->view('header'); ?>
    ...
    <div class="panel-heading"><img src="<?php echo base_url().RES_DIR; ?>/img/services-icons/health_checkup_48.png" width="48" height="41"> <?=lang('menu_urban_health_booking')?></div>
    <div class="panel-body">
       
   
    <?php echo form_open('booking/urban_health_booking/search_urban_health_checkup_list') ?>
...
<th><?=lang('site')?></th>
            ...
            <tr id="row_<?=$i?>">
				...
				?>
                <a href="<?php echo base_url().'booking/urban_health_booking/create_urban_health_booking/'.$health_checkup->registration_no;?>" class="btn btn-small btn-info"><?=lang('website_create')?> <?=lang('website_booking')?></a>
                <?php
				endif; 
				?>
                </td>                

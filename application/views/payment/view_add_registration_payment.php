...
<?php echo $this->load->view('header'); ?>
    ...
    <div class="span8">    
 	...
 	<table class="table table-bordered">
        ...
        <input type="radio" name="payment_status" id="payment_status_free" value="Free"  onclick="javascript:clean_received_payment();">Free</label>
        <label class="radio inline">
        <input type="radio" name="payment_status" id="payment_status_paid" value="Paid" checked  onclick="javascript:clean_received_payment();">Paid</label>
            </td>                       
        </tr>
        <tr>
	        <td>Received amount</td>
            <td><input class="span1"  name="received_amount" id="received_amount" value="5" type="text"  />     <?=lang('taka')?> </td>
        </tr>

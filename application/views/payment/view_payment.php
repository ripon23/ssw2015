...
<?php echo $this->load->view('header'); ?>
    ...
    <?php echo form_open('payment/payment/search_payment_list') ?>
...
<th><?=lang('site')?></th>
            ...
            <tr id="row_<?=$i?>">
                ...
                <td><?php echo $payment->services_date; ?></td>
                <td>
				<?php 
				...
				if($payment_status)
				{
					...
					echo '<a href="'.base_url().'payment/payment/view_single_payment/'.$payment->reg_for_service_id.'" class="btn btn-small btn-success">'.lang('website_view').'</a>&nbsp;';
					endif;
					if ($this->authorization->is_permitted('edit_payment')) :
					echo '<a href="'.base_url().'payment/payment/edit_single_payment/'.$payment->reg_for_service_id.'" class="btn btn-small btn-warning">'.lang('website_edit').'</a>&nbsp;';
					endif;
					}

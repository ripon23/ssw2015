    	    ...
    	    <input class="input-mini" placeholder="XXXXXX" name="phone_part2" id="phone_part2" value="<?php echo $phone_part2;?>" type="text" />
                ...
                <div class="control-group">
                    ...
                    <select name="learning_type" id="learning_type" class="input-medium">
                		...
                		<option value="<?php echo $learning_type1->learning_type_id;?>"><?php echo $this->session->userdata('site_lang')=='english'? $learning_type1->type_name:$learning_type1->type_name_bn; ?></option>
                <?php endforeach; ?> 
                    </select>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input class="input-mini"  name="duration" id="duration"  value="<?php echo set_value('duration');?>" type="text" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <textarea rows="5" name="description" id="description" value="<?php echo set_value('description');?>" class="input-xlarge"></textarea>  
                    </div>
                </div>

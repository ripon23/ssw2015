...
<?php echo $this->load->view('header'); ?>
    ...
    <form class="form-horizontal" id="social-goods-form" action="" method="post" enctype="multipart/form-data">        
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input class="input-large"  name="consumable_name" id="consumable_name" placeholder="Consumable Name"  value="<?php echo set_value('consumable_name');?>" type="text" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    <label class="control-label" for="consumable_site"><?=lang('site')?> *:</label>        
                    <div class="controls">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="consumable_per_price"  placeholder="Per consumable price" value="<?php echo set_value('consumable_per_price');?>" class="input-large" id="consumable_per_price"/>
                    </div>
                </div>                               
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="consumable_stock"  placeholder="Consumable Stock" value="<?php echo set_value('consumable_stock');?>" class="input-large" id="consumable_stock"/>
                    </div>
                </div>                               
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <textarea rows="3" placeholder="Consumable note" name="consumable_note" id="consumable_note"><?php echo set_value('consumable_note');?></textarea>        
                    </div>
                </div>
